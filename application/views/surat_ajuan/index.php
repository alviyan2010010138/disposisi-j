                                ...
                                $no =1;
                                    foreach ($surat as $suratdata) {
                                        echo "<tr>
                                            ...
                                            <td>
                                                <div>
                                                    <a href=".base_url('surat_ajudan/getedit/' . $suratdata->id)." class='btn-sm btn-info'><i class='fas fa-edit'></i> Edit</a>
                                                    <a href=".base_url('surat_ajuan/delete/ . $suratdata->id." class='btn btn-sm btn-danger' 
                                                        onclick='return confirm(\"Ingin menghapus data surat ajuan ini?\");'><i class='fas fa-trash'></i> Hapus</a>
                                                </div>
                                            </td>
                                        </tr>";
                                        $no++;
