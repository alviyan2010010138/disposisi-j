    ...
    <div class="countainer-fluid">
        ...
        <div class="card mb-4">
            ...
            <div class="mb-3>
                ...
                <input class="form-control" type="text" name="surat_form" placeholder="SURAT DARI" required />
            </div>
            <div class="mb-3>
            ...
            <form action="<?php echo site_url('surat_ajuan/save') ?>" method="post" enctype="multipart/form-data"></form>
        </div>
    </div>
